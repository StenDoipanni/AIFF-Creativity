...
if __name__ == "__main__":
    FILE_PATH = "/Users/stefanodegiorgis/Desktop/AI-Film-Festival/AI_film_festival_enrichment.tsv"
    API_KEY = ""
    
    NARRATIVE_PROMPT = """
    You receive a piece of text with a small story. Consider the following narrative roles:
    ...
    Identify in the piece of text if there is any of these roles, e.g. 
    ...
    If you need, introduce new roles accordingly to the elements that you identify as relevant in the story, the important is that you keep
    all the participants which are relevant for the small story.
